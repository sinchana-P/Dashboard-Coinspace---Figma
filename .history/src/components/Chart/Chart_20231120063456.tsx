                ...
                <div className='chart-sec-right'>
                  ...
                  <div className='market-cap-div'>
                    <div className='market-cap-div-left'>
                      <FaBitcoin size={18} style={{ color: "white", backgroundColor: "#FFC246", width: "20px", height: "20px", borderRadius: "50%", padding: "6px" }} />
                      <h2>BTC</h2>
                    </div>               
                  ...
                  <div className='market-cap-div'>
                    <div className='market-cap-div-left'>
                      <SiBitcoincash size={18} style={{ color: "white", backgroundColor: "#DE510F", width: "20px", height: "20px", borderRadius: "50%", padding: "6px" }} />
                      <h2>BCH</h2>
                    </div>               
                    <div className='market-cap-div-right'>
                      <h2>¥ 48,676</h2>
                  ...
                  <div className='market-cap-div'>
                    <div className='market-cap-div-left'>
                      <FaEthereum size={18} style={{ color: "white", backgroundColor: "#1E11D6", width: "20px", height: "20px", borderRadius: "50%", padding: "6px" }} />
                      <h2>ETH</h2>
                    </div>               
                    <div className='market-cap-div-right'>
                      <h2>¥ 22,370</h2>
                  ...
                  <div className='market-cap-div'>
                    <div className='market-cap-div-left'>
                      <SiLitecoin size={18} style={{ color: "white", backgroundColor: "#AA9B94", width: "20px", height: "20px", borderRadius: "50%", padding: "6px" }} />
                      <h2>LTC</h2>
                    </div>               
                    <div className='market-cap-div-right'>
                      <h2>¥ 5,788.5</h2>
                  ...
                  <div className='market-cap-div'>
                    <div className='market-cap-div-left'>
                      <TbCurrencyEthereum size={18} style={{ color: "white", backgroundColor: "#19B73C", width: "20px", height: "20px", borderRadius: "50%", padding: "6px" }} />
                      <h2>ETC</h2>
                    </div>               
                    <div className='market-cap-div-right'>
                      <h2>¥ 1,660.7</h2>
                  ...
                  <div className='market-cap-div'>
                    <div className='market-cap-div-left'>
                      <SiXrp size={18} style={{ color: "white", backgroundColor: "#4F6BE8", width: "20px", height: "20px", borderRadius: "50%", padding: "6px" }} />
                      <h2>XRP</h2>
                    </div>               
                    <div className='market-cap-div-right'>
                      <h2>¥ 50.839</h2>
                  ...
                  <div className='market-cap-div'>
                    <div className='market-cap-div-left'>
                      <FaBitcoin size={18} style={{ color: "white", backgroundColor: "#2F344B", width: "20px", height: "20px", borderRadius: "50%", padding: "6px" }} />
                      <h2>FCT</h2>
                    </div>               
                    <div className='market-cap-div-right'>
                      <h2>¥ 534.68</h2>
                  ...
                  <div className='market-cap-div'>
                    <div className='market-cap-div-left'>
                      <FaBitcoin size={18} style={{ color: "white", backgroundColor: "#04167B", width: "20px", height: "20px", borderRadius: "50%", padding: "6px" }} />
                      <h2>LSK</h2>
                    </div>               
                    <div className='market-cap-div-right'>
                      <h2>¥ 321.14</h2>
                  ...
                  <div className='market-cap-div'>
                    <div className='market-cap-div-left'>
                      <TbBrandNem size={18} style={{ color: "white", backgroundColor: "#77ECC7", width: "20px", height: "20px", borderRadius: "50%", padding: "6px" }} />
                      <h2>XEM</h2>
                    </div>               
                    <div className='market-cap-div-right'>
                      <h2>¥ 10.604</h2>
