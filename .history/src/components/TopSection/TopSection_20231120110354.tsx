...
export const TopSection = () => {
  return (
    <div className='top-section-container-main'>
      <div className='welcome-icons-containe'>
        ...
        <div className='icons-container'>
          <div className='icons-right'><HiOutlineSquares2X2 /></div>
          <div className='icons-right'><SlArrowRight /></div>
          <div className='icons-right'><SlArrowLeft /></div>
        </div>
      </div>
