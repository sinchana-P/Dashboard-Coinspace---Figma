    ...
    <div className='top-section-container-main'>
      ...
      <div className='top-section-container'>
          ...
          <Card>
            <div className='top-card'>
              <div className='top-card-each-col'>
                <FaBitcoin size={20} style={{ color: "white", backgroundColor: "#FFC246", width: "35px", height: "35px", borderRadius: "50%", padding: "6px" }} />
              </div>
          ...
          <Card>
            <div className='top-card'>
              <div className='top-card-each-col'>
                <FaEthereum size={20} style={{ color: "white", backgroundColor: "#5470DE", width: "35px", height: "35px", borderRadius: "50%", padding: "6px" }}/>
              </div>
          ...
          <Card>
            <div className='top-card'>
              <div className='top-card-each-col'>
                <TbBrandNem size={20} style={{ color: "white", backgroundColor: "#07BEAA", width: "35px", height: "35px", borderRadius: "50%", padding: "6px" }}/>
              </div>
              <div className='top-card-text'>
                <h1>XEM</h1>
                <p>NEM</p>
          ...
          <Card>
            <div className='top-card'>
              <div className='top-card-each-col'>
                <SiXrp size={20} style={{ color: "white", backgroundColor: "#1786C4", width: "35px", height: "35px", borderRadius: "50%", padding: "6px" }}/>
              </div>
              <div className='top-card-text'>
                <h1>XRP</h1>
                <p>Ripple</p>
