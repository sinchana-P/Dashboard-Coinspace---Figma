...
var SiderContext = React30.createContext({});
var generateId = (() => {
  let i = 0;
  return function() {
...
var Sider = React30.forwardRef((props, ref) => {
  const {
  ...
  const {
    siderHook
  } = (0, import_react13.useContext)(LayoutContext);
  const [collapsed, setCollapsed] = (0, import_react13.useState)("collapsed" in props ? props.collapsed : defaultCollapsed);
  const [below, setBelow] = (0, import_react13.useState)(false);
  ...
  const responsiveHandlerRef = (0, import_react13.useRef)();
  ...
  const renderSider = () => {
    ...
    const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React30.createElement("span", {
      onClick: toggle,
    ...
    }, trigger || React30.createElement(BarsOutlined_default, null)) : null;
    const iconObj = {
      expanded: reverseArrow ? React30.createElement(RightOutlined_default, null) : React30.createElement(LeftOutlined_default, null),
      collapsed: reverseArrow ? React30.createElement(LeftOutlined_default, null) : React30.createElement(RightOutlined_default, null)
    };
    const status = collapsed ? "collapsed" : "expanded";
    const defaultTrigger = iconObj[status];
    const triggerDom = trigger !== null ? zeroWidthTrigger || React30.createElement("div", {
    ...
    return React30.createElement("aside", Object.assign({
      className: siderCls
    }, divProps, {
      style: divStyle,
      ref
  ...
  return React30.createElement(SiderContext.Provider, {
    value: contextValue
  }, renderSider());
});
if (true) {
...
//# sourceMappingURL=chunk-HKZPDD2I.js.map
