...
MonotoneX2.prototype = {
  ...
  point: function point5(x2, y2) {
    ...
    switch (this._point) {
      ...
      case 2:
        this._point = 3;
        _point(this, slope22(this, t1 = slope32(this, x2, y2)), t1);
        break;
      default:
        _point(this, this._t0, t1 = slope32(this, x2, y2));
        break;
    }
    ;
    this._x0 = this._x1, this._x1 = x2;
...
function defaultLocale(definition) {
  ...
  timeFormat2 = locale.format;
  timeParse = locale.parse;
  utcFormat2 = locale.utcFormat;
...
function utcTime() {
  return initRange.apply(calendar(utcTicks, utcTickInterval, utcYear_default, utcMonth_default, utcSunday, utcDay_default, utcHour_default, utcMinute_default, second_default, utcFormat2).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
...
function stackSeries2(series, axisOptions) {
  ...
  var stacker = stack_default().keys(seriesIndices).value(function(_, seriesIndex, index) {
...
function collinear(d) {
  ...
  for (let i = 0; i < triangles.length; i += 3) {
    const a2 = 2 * triangles[i], b = 2 * triangles[i + 1], c = 2 * triangles[i + 2], cross = (coords[c] - coords[a2]) * (coords[b + 1] - coords[a2 + 1]) - (coords[b] - coords[a2]) * (coords[c + 1] - coords[a2 + 1]);
    if (cross > 1e-10)
      return false;
  }
  return true;
