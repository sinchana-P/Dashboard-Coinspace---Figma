...
function MotionProvider(_ref) {
  ...
  return React25.createElement(Context.Provider, {
    value: props
  }, children);
}
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React31.forwardRef(function(props, ref) {
    ...
    var _React$useContext = React31.useContext(Context), contextMotion = _React$useContext.motion;
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        var Component3 = component || React32.Fragment;
        var motionProps = {};
        ...
        return React32.createElement(Component3, restProps, keyEntities.map(function(_ref2, index) {
...
function MotionWrapper(props) {
  ...
  if (needWrapMotionProviderRef.current) {
    return React33.createElement(MotionProvider, {
      motion
    }, children);
  }
  return children;
...
var PropWarning = React34.memo((_ref) => {
  let {
...
var ProviderChildren = (props) => {
  ...
  let childNode = React35.createElement(React35.Fragment, null, React35.createElement(PropWarning_default, {
    dropdownMatchSelectWidth
  }), children);
  ...
  if (Object.keys(validateMessages).length > 0) {
    childNode = React35.createElement(validateMessagesContext_default.Provider, {
  ...
  if (memoedConfig.warning) {
    childNode = React35.createElement(WarningContext.Provider, {
...
var LayoutContext = React36.createContext({
  siderHook: {
    addSider: () => null,
    removeSider: () => null
  }
...
var SiderContext = React37.createContext({});
var generateId = (() => {
  let i = 0;
  return function() {
...
var Sider = React37.forwardRef((props, ref) => {
  const {
  ...
  const renderSider = () => {
    ...
    const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React37.createElement("span", {
      onClick: toggle,
    ...
    }, trigger || React37.createElement(BarsOutlined_default2, null)) : null;
    const iconObj = {
      expanded: reverseArrow ? React37.createElement(RightOutlined_default2, null) : React37.createElement(LeftOutlined_default2, null),
      collapsed: reverseArrow ? React37.createElement(LeftOutlined_default2, null) : React37.createElement(RightOutlined_default2, null)
    };
    const status = collapsed ? "collapsed" : "expanded";
    const defaultTrigger = iconObj[status];
    const triggerDom = trigger !== null ? zeroWidthTrigger || React37.createElement("div", {
    ...
    return React37.createElement("aside", Object.assign({
      className: siderCls
    }, divProps, {
      style: divStyle,
      ref
  ...
  return React37.createElement(SiderContext.Provider, {
    value: contextValue
  }, renderSider());
});
if (true) {
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7AV53DJV.js.map
